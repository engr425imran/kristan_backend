            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="{{url('admin/dashboard')}}" class="logo">
                        <span>
                            <img src="{{asset('assets/img/logo-accuo.png')}}" alt="Valet pro logo" height="55" width="40%">
                        </span>
                        <i>
                            <img src="{{asset('assets/img/logo-accuo.png')}}" alt="Valet pro logo" height="38">
                        </i>
                    </a>
                </div>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img src="{{asset('assets/img/user.jpg')}}" alt="admin" class="rounded-circle">
                            </a>
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li >
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <!-- <li class=""><a href="{{url('admin/vendor')}}">Vendor</a></li> -->
                                    <li class=""><a href="{{url('admin/users/manager')}}">Valet Manager</a></li>
                                    <li class=""><a href="{{url('admin/users/valet')}}">Valet</a></li>
                                    <li class=""><a href="{{url('admin/users/customer')}}">Customer</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fi-paper"></i> <span> CMS </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{url('admin/cms/about')}}">About Us</a></li>
                                    <li><a href="{{url('admin/cms/faq')}}">FAQ</a></li>
                                    <li><a href="{{url('admin/cms/terms')}}">Terms of Service</a></li>
                                </ul>
                            </li>
                            <li >
                                <a href="javascript: void(0);"><i class="fi-file"></i> <span> Reports </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li class=""><a href="{{url('admin/report/allUsers')}}">All user type report</a></li>
                                    <li class=""><a href="{{url('admin/report/revenue')}}">Revenue report</a></li>
                                    <li class=""><a href="{{url('admin/report/ratings')}}">Ratings report</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="{{url('admin/setting')}}"><i class="fi-cog"></i> <span> Site Setting </span></a>
                            </li>
                            
                            <!-- <li>
                                <a href="/admin/organisationGate/">
